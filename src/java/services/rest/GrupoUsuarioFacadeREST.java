...
@Stateless
@Path("grupousuario")
public class GrupoUsuarioFacadeREST extends AbstractFacade<GrupoUsuario> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, GrupoUsuario entity) {
        super.edit(entity);
    }
    ...
    public GrupoUsuario find(@PathParam("id") String id) {
